...
ICONS = {
    # building web apps: a browser window
    'window': [
        '............',
        '.##########.',
        '.#%.%.%...#.',
    ...
    # agentic development: a robot, antenna up
    'robot': [
        '............',
        '.....%%.....',
        '.....##.....',
    ...
    # integrations: one system wired to the two beside it
    'nodes': [
        '............',
        '....####....',
        '....####....',
    ...
    # security review: a shield, keyhole cut through it
    'shield': [
        '............',
        '.##########.',
        '.##########.',
